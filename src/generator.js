export default Blockly => {
    Blockly.Python.microbit_pin_setDigitalOutput = function (block) {
        ...
        const level = Blockly.Python.valueToCode(block, 'LEVEL', Blockly.Python.ORDER_FUNCTION_CALL) || 'LOW';
    ...
    Blockly.Python.microbit_display_showImage = function (block) {
        let arg0 = Blockly.Python.valueToCode(block, 'VALUE', Blockly.Python.ORDER_ATOMIC) || '0';
    ...
    Blockly.Python.microbit_display_showImageUntil = function (block) {
        let arg0 = Blockly.Python.valueToCode(block, 'VALUE', Blockly.Python.ORDER_ATOMIC) || '0';
        const arg1 = Blockly.Python.valueToCode(block, 'TIME', Blockly.Python.ORDER_ATOMIC) || '0';
    ...
    Blockly.Python.microbit_display_show = function (block) {
        const arg0 = Blockly.Python.valueToCode(block, 'TEXT', Blockly.Python.ORDER_FUNCTION_CALL) || '';
    ...
    Blockly.Python.microbit_display_lightPixelAt = function (block) {
        let sta = block.getFieldValue('STATE');
        const x = Blockly.Python.valueToCode(block, 'X', Blockly.Python.ORDER_FUNCTION_CALL) || '';
        const y = Blockly.Python.valueToCode(block, 'Y', Blockly.Python.ORDER_FUNCTION_CALL) || '';
    ...
    Blockly.Python.microbit_display_showOnPiexlbrightness = function (block) {
        const brt = Blockly.Python.valueToCode(block, 'BRT', Blockly.Python.ORDER_FUNCTION_CALL) || '9';
        const x = Blockly.Python.valueToCode(block, 'X', Blockly.Python.ORDER_FUNCTION_CALL) || '';
        const y = Blockly.Python.valueToCode(block, 'Y', Blockly.Python.ORDER_FUNCTION_CALL) || '';
    ...
    Blockly.Python.microbit_display_menu_ledBrightness = function (block) {
        const code = block.getFieldValue('ledBrightness') || '9';
        return [code, Blockly.Python.ORDER_ATOMIC];
    };
